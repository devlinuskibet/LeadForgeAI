...
class AIRequest(Base):
    ...
    prompt_version_id = Column(UUID(as_uuid=True), ForeignKey("ai_prompt_versions.id"), nullable=True)
...
class AIUsage(Base):
    ...
    request_id = Column(UUID(as_uuid=True), ForeignKey("ai_requests.id"), nullable=False, unique=True, index=True)
